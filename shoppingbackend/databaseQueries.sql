...
VALUES ('Virat', 'Kohli', 'ADMIN', true, '$2a$06$xetAb1jOIwNkHPxmwoIhM.3VXQcxzOJGONIxXvD9DSGz.9Qt6c53m', 'vk@gmail.com', '8888888888');

INSERT INTO user_detail 
(first_name, last_name, role, enabled, password, email, contact_number) 
VALUES ('Ravindra', 'Jadeja', 'SUPPLIER', true, '$2a$06$ICHXPgDx9HxMNgRamptnE.Nc2s0p/YaEsq43OZj.a2yDywtNAOQUK', 'rj@gmail.com', '9999999999');

INSERT INTO user_detail 
(first_name, last_name, role, enabled, password, email, contact_number) 
VALUES ('Ravichandra', 'Ashwin', 'SUPPLIER', true, '$2a$06$ASpa6T0OFNo7WVTNaDYU/ezRjaGlcKan39uot2xSaHNIjQWOWh1Iq', 'ra@gmail.com', '7777777777');
...
INSERT INTO product (code, name, brand, description, unit_price, quantity, is_active, category_id, supplier_id)
VALUES ('PRDABCXYZGGWP', 'ez25', 'Vladofon', 'Best of the best', 1000000, 1, true, 3, 2 );
