...
import net.onlineshopping.util.FileUploadUtility;
import net.onlineshopping.validator.ProductValidator;
...
public class ManagementController {
	...
	public String handleProductsSubmission(@Valid @ModelAttribute("product") Product mProduct, BindingResult results, Model model, HttpServletRequest request) {
